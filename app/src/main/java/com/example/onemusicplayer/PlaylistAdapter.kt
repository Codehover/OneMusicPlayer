...
import com.example.onemusicplayer.databinding.PlaylistViewBinding
...
class PlaylistAdapter(
    ...
    class MyHolder(binding: PlaylistViewBinding) : RecyclerView.ViewHolder(binding.root) {
        val image = binding.songImagePLV
        val songName = binding.songNamePLV
        val deleteButton = binding.deleteBtnPLV
    ...
    override fun onBindViewHolder(holder: MyHolder, position: Int) {
        holder.songName.text = playList[position].name
        ...
        holder.root.setOnClickListener {
            val intent = Intent(context,PlaylistDetail::class.java)
